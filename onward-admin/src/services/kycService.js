...
// KYC approval bonus config
export const getKycConfig = () => api.get('/kyc/config').then((r) => r.data);
export const saveKycConfig = (kycBonus) => api.put('/kyc/config', { kycBonus }).then((r) => r.data);
